...
ALTER TABLE movies DROP CONSTRAINT IF EXISTS movies_created_by_fkey;
ALTER TABLE purchases DROP CONSTRAINT IF EXISTS purchases_user_id_fkey;
ALTER TABLE purchases DROP CONSTRAINT IF EXISTS purchases_movie_id_fkey;
...
ALTER TABLE favorites DROP CONSTRAINT IF EXISTS favorites_movie_id_fkey;
...
ALTER TABLE movies ADD CONSTRAINT movies_created_by_fkey 
  FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL;

ALTER TABLE purchases ADD CONSTRAINT purchases_user_id_fkey 
  FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;

ALTER TABLE purchases ADD CONSTRAINT purchases_movie_id_fkey 
  FOREIGN KEY (movie_id) REFERENCES movies(id) ON DELETE CASCADE;

ALTER TABLE watch_history ADD CONSTRAINT watch_history_user_id_fkey 
  FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;

ALTER TABLE watch_history ADD CONSTRAINT watch_history_movie_id_fkey 
  FOREIGN KEY (movie_id) REFERENCES movies(id) ON DELETE CASCADE;

ALTER TABLE favorites ADD CONSTRAINT favorites_user_id_fkey 
  FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;

ALTER TABLE favorites ADD CONSTRAINT favorites_movie_id_fkey 
  FOREIGN KEY (movie_id) REFERENCES movies(id) ON DELETE CASCADE;
